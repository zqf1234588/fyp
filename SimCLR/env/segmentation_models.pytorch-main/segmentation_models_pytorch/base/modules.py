...
class Attention(nn.Module):
    def __init__(self, name, **params):
        ...
        if name is None:
            ...
            self.attention = CBAMBlock(**params)
        elif name == "ACmix":
            self.attention = ACmix(**params)
        elif name == "Axial":
            self.attention = AxialImageTransformer(**params)
        elif name == "CrissCrossAttention":
            self.attention = CrissCrossAttention(**params)
        elif name == "CoordAttention":
            self.attention = CoordAtt(**params)
        elif name == "SimAM":
            self.attention = SimAM(**params)
        else:
