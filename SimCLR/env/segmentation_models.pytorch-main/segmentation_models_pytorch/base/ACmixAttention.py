...
class ACmix(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_att=7, head=4, kernel_conv=3, stride=1, dilation=1):
        ...
        self.dep_conv = nn.Conv2d(self.kernel_conv * self.kernel_conv * self.head_dim, out_channels, kernel_size=self.kernel_conv, bias=True, groups=self.head_dim, padding=1, stride=stride)
